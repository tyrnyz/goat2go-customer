...
const commonAddOns: AddOn[] = [
  ...
  { id: "addon-no-msg", name: "No MSG", price: 0 },
  { id: "addon-spicy", name: "Extra Spicy", price: 0 },
];
...
const LOCAL_IMAGE_MAP: Record<string, string> = {
  ...
  "Papaitam Kambing": "/meat_images/papaitan_kambing.jpg",
  ...
  "Chopsuey": "/veggies_images/chopseuy.jpg",
...
const DESCRIPTION_MAP: Record<string, string> = {
  ...
  "Papaitam Kambing": "Delicious Papaitam Kambing served hot and fresh.",
  ...
  "Chopsuey": "Delicious Chopsuey served hot and fresh.",
